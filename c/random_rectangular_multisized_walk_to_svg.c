 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Perform a random walk with steps in {t*North, t*South, t*East, t*West}*
 *      where t is any real number between 0 and 1.                           *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 16, 2021                                                  *
 ******************************************************************************/
...
/*  Function for computing a random direction in the set                      *
 *  {t*North, t*South, t*East, t*West | 0 <= t <= 1}.                         */
static struct pair random_pair(void)
{
    /*  Get a random number between 0 and 1 to represent the size of the step.*/
...
int main(void)
{
    ...
    FILE *fp = fopen("tmpl_random_walk_rectangular_multisized.svg", "w");
