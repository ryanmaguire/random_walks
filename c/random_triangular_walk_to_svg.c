 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Perform a random walk with steps on the vertices of an equilateral    *
 *      triangle.                                                             *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 16, 2021                                                  *
...
/*  Function for computing a random direction on an equilateral triangle.     */
static struct pair random_pair(void)
{
    /*  Get a random integer between 0 and 2 for the direction of the step.   */
    int rint = (int)(3.0 * (double)rand() / (double)RAND_MAX);
    ...
    {
        out.x = -0.8660254037844386467637;
        out.y = -0.5;
    }
    else
    {
...
int main(void)
{
    ...
    FILE *fp = fopen("tmpl_random_walk_triangle.svg", "w");
