 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Perform a random walk with steps on the vertices of a star.           *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 16, 2021                                                  *
 ******************************************************************************/
...
/*  Function for computing a random direction on the vertices of a star.      */
static struct pair random_pair(void)
{
    /*  Get a random integer between 0 and 9 for the direction of the step.   */
    int rint = (int)(10.0 * (double)rand() / (double)RAND_MAX);
...
int main(void)
{
    ...
    FILE *fp = fopen("random_walk_star.svg", "w");
